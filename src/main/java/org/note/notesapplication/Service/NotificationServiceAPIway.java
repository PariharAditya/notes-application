...
@Service
public class NotificationServiceAPIway {
    /*
    Follow of sending mail via sendgrid
    1. create sending mail (Email and Mail)
    2. Request via Sendgrid
    3. Response anc check if the response is successful(Optional)
    */
