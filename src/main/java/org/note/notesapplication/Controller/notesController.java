...
public class notesController {
    ...
    @Operation(
            ...
            description = "This endpoint retrieves all notes for a specific user. " +
    ...
    @Operation(
            ...
            description = "Retrieves a specific note by title for a user",
    ...
    @Operation(
            summary = "Update note",
            description = "Updates an existing note by title for a user",
    ...
    @Operation(
            summary = "Delete note",
            description = "Deletes a specific note by title for a user",
