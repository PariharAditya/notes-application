...
public class NotificationController {
    ...
    @Operation(
            ...
            description = "Sends an email notification to the specified email address with custom subject and body",
            responses = {
    ...
    @Parameters({
            ...
            @Parameter(
                    name = "message",
                    description = "Message to be sent in the SMS",
                    required = true
            )
    })
    ...
    @Operation(
            summary = "Manually trigger report generation and sending",
            description = "CRON Job " +
                    "This endpoint allows you to manually trigger the report generation and sending process.",
            responses = {
